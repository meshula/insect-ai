...
void DrawCircle(PMath::Vec2f p);
void DrawFilledCircle(PMath::Vec2f p);
...
/// @brief	Agent base class
    ...
    static const  char* static_name() { return "Agent"; }
...
///			Lights are implemented as agents because Sensors are sensitive to agents
	...
	public:
        ...
        static const  char* static_name() { return "Light"; }
        virtual const char* name() const override { return static_name(); }

        virtual void			Update(float dt) override;
		virtual uint32			GetKind() const	override    { return kKindLight; }
